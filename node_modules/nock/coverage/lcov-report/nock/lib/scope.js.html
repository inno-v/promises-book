...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">92.72% <small>(280 / 302)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">81.87% <small>(149 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">89.47% <small>(51 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">92.67% <small>(278 / 300)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
703
704
705</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        if(typeof this.options[opt] === 'undefined') {</span>
...
&nbsp;
    function reply(statusCode, body, headers) {
      if (arguments.length &lt;= 2 &amp;&amp; typeof statusCode === 'function') {
        body = statusCode;
        statusCode = 200;
      }
&nbsp;
